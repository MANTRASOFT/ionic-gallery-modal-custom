(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('ionic-angular/index'), require('rxjs/Subject')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', 'ionic-angular/index', 'rxjs/Subject'], factory) :
	(factory((global['ionic-gallery-modal'] = global['ionic-gallery-modal'] || {}),global._angular_core,global._angular_common,global.ionicAngular_index,global.rxjs_Subject));
}(this, (function (exports,_angular_core,_angular_common,ionicAngular_index,rxjs_Subject) { 'use strict';

var ZoomableImage = (function () {
    function ZoomableImage() {
        this.disableScroll = new _angular_core.EventEmitter();
        this.enableScroll = new _angular_core.EventEmitter();
        this.scale = 1;
        this.scaleStart = 1;
        this.maxScale = 3;
        this.minScale = 1;
...
var GalleryModal = (function () {
    ...
    function GalleryModal(viewCtrl, params, element, platform) {
        ...
        this.parentSubject = new rxjs_Subject.Subject();
        this.width = 0;
        this.height = 0;
        this.slidesStyle = {
            visibility: 'hidden',
...
GalleryModal.ctorParameters = function () { return [
    { type: ionicAngular_index.ViewController, },
    { type: ionicAngular_index.NavParams, },
    { type: _angular_core.ElementRef, },
    { type: ionicAngular_index.Platform, },
]; };
GalleryModal.propDecorators = {
    'slider': [{ type: _angular_core.ViewChild, args: ['slider',] },],
    'content': [{ type: _angular_core.ViewChild, args: ['content',] },],
};
...
var TouchEventsDirective = (function () {
    ...
    function TouchEventsDirective(el) {
        ...
        this.direction = 'x';
        this.threshold = 10;
        this.pinch = new _angular_core.EventEmitter();
        this.pinchstart = new _angular_core.EventEmitter();
        this.pinchend = new _angular_core.EventEmitter();
        this.onpan = new _angular_core.EventEmitter();
        this.panup = new _angular_core.EventEmitter();
        this.pandown = new _angular_core.EventEmitter();
        this.panstart = new _angular_core.EventEmitter();
        this.panend = new _angular_core.EventEmitter();
        this.pancancel = new _angular_core.EventEmitter();
        this.doubletap = new _angular_core.EventEmitter();
    }
    /**
     * @return {?}
     */
    TouchEventsDirective.prototype.ngOnInit = function () {
        var _this = this;
        this.gestureListener = new ionicAngular_index.Gesture(this.el.nativeElement, {
            domEvents: false,
...
TouchEventsDirective.propDecorators = {
    ...
    'pinch': [{ type: _angular_core.Output },],
    'pinchstart': [{ type: _angular_core.Output },],
    'pinchend': [{ type: _angular_core.Output },],
    'onpan': [{ type: _angular_core.Output },],
    'panup': [{ type: _angular_core.Output },],
    'pandown': [{ type: _angular_core.Output },],
    'panstart': [{ type: _angular_core.Output },],
    'panend': [{ type: _angular_core.Output },],
    'pancancel': [{ type: _angular_core.Output },],
    'doubletap': [{ type: _angular_core.Output },],
};
...
GalleryModalModule.decorators = [
    { type: _angular_core.NgModule, args: [{
                imports: [
                    ...
                    ionicAngular_index.IonicModule.forRoot(TouchEventsDirective),
                    ionicAngular_index.IonicModule.forRoot(ZoomableImage),
                    ionicAngular_index.IonicModule.forRoot(GalleryModal),
                ],
                declarations: [
                    ZoomableImage,
                    GalleryModal,
...
exports.GalleryModalModule = GalleryModalModule;
